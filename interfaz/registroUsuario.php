...
// Detectar si hay un admin logueado
$rolUsuario = $_SESSION['usuario']['rol'] ?? ''; // '' = no logueado
$soloAdmin = ($rolUsuario === 'Administrador'); // true solo si es Admin
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <div class="form-card">
        ...
        <form action="../logica/procesarRegistro.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="input-group">
                <label>Rol</label>
                <?php if ($soloAdmin): ?>
                    <!-- Un admin logueado solo puede crear otro admin -->
