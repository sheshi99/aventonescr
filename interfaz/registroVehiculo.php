...
<form action="../logica/procesarVehiculo.php" method="post" enctype="multipart/form-data">
    ...
    <input type="text" name="color" id="color" value="<?= htmlspecialchars($vehiculo['color']) ?>" required><br><br>

    <label for="marca">Marca:</label>
    <input type="text" name="marca" id="marca" value="<?= htmlspecialchars($vehiculo['marca']) ?>" required><br><br>

    <label for="modelo">Modelo:</label>
    <input type="text" name="modelo" id="modelo" value="<?= htmlspecialchars($vehiculo['modelo']) ?>" required><br><br>

    <label for="anno">Año:</label>
    <input type="number" name="anno" id="anno" min="1900" max="<?= date('Y') ?>" value="<?= htmlspecialchars($vehiculo['anno']) ?>" required><br><br>

    <label for="asientos">Asientos:</label>
    <input type="number" name="asientos" id="asientos" min="1" value="<?= htmlspecialchars($vehiculo['asientos']) ?>" required><br><br>
